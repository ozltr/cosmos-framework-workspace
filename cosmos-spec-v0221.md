# Cosmos Framework Spec v0.2.2.1
- *Genesis document for the second iteration of the galaxy system framework.*
- *Written: 2026-04-25*
...
| Section | Title | Human Onboarding |
|---|---|---|
| **Level 1** | **Cosmos Architecture** | |
| 1 | Core Concepts | *yes* |
| 2 | Ontology | *yes* |
| 2.1 | Ontology — Industry standard, established conventions | *yes* |
| 2.2 | Ontology — Cosmos specific | *yes* |
| 3 | Capabilities | |
| 4 | Galaxy Structure — directory of files, agent friendly | *yes* |
...
| 7 | Token-Efficient Cold Start | *yes* |
| 8 | Bootstrap | |
| 9 | Migration (v0.1 → v0.2.2) | |
| 10 | Onboarding Protocol | *yes* |
| 11 | Thunder | |
...
*Important for human onboarding*
...
Ontology is the branch of philosophy studying existence and reality, focusing on what entities exist and how they can be categorized

#### 2.1 Ontology - Industry standard, established conventions applicable outside of this framework
...
Every galaxy — including the universes themselves — follows this skeleton:
...
│   ├── agent-spec/          ← agent runtime: pushed from universe, projected to providers
│   │   ├── conventions.md
│   │   ├── ethics.md
...
*Only important for galaxy owners*
...
| v0.2.2.1 | 2026-04-25 | Index updated to reflect actual section structure including subsections 2.1, 2.2, 6.1, 6.2, 6.3. Added *Human Onboarding* column to index. |
